        ...
        : GOSTStribog256
    {
        ...
        private byte[] AddModulo512(byte[] a, byte[] b)
        {
            unchecked
            {
                ...
                Buffer.BlockCopy(a, 0, tempA, 64 - a.Length, a.Length);
                Buffer.BlockCopy(b, 0, tempB, 64 - b.Length, b.Length);
        ...
        protected override void HashCore(byte[] array, int ibStart, int cbSize)
        {
            unchecked
            {
                ...
                if (message1.Length < 64)
                {
                    ...
                    paddedMessage[64 - message1.Length - 1] = 0x01;
                    Buffer.BlockCopy(message1, 0, paddedMessage, 64 - message1.Length, message1.Length);
                }

                h = G_n(_n, h, paddedMessage);
                var messageLen = BitConverter.GetBytes(message1.Length * 8);
                Array.Reverse(messageLen);                          // <-- Check copying.
